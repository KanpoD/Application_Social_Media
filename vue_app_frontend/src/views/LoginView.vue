  ...
  <div class="max-w-7xl mx-auto grid grid-cols-2 gap-4">
      <div class="main-left">
          <div class="p-12 bg-white border border-gray-200 rounded-lg">
              ...
              <p class="font-bold">
                  Don't have an account? <RouterLink :to="{'name': 'register'}" class="underline">Click here</RouterLink> to create one!
              </p>
          </div>
      </div>
          ...
          <div class="p-12 bg-white border border-gray-200 rounded-lg">
              <form class="space-y-6" v-on:submit.prevent="submitForm">
                  <div>
                      ...
                      <input type="email" placeholder="Your e-mail address" v-model="form.email" class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                  </div>
